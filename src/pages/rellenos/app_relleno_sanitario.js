...
function getColor_poblacion(valuep) {
    return  valuep <= 2499 ? 'rgb(218, 218, 212 )' :
            valuep >= 2500 ? 'rgb(111, 111, 103  )':
           'rgb(111, 111, 103  )'; //máxima poblacion
}
...
localidades=L.geoJson(localidades_poligonos, {
    style: function(feature) {
        return { weight:0,fillColor:getColor_poblacion(feature.properties.POB1), fillOpacity: 0.9 };
...
/*legend*/
  ...
  elem.src = 'mapas_relleno_sanitario/poblacion.png';
